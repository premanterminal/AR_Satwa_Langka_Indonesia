...
namespace OpenCVForUnity
{
    public static class Utils
    {
        ...
        /**
        * Gets the OpenCV for Unity Version.
        */
     ...
     */
        public static void copyFromTexture (Texture texture, IntPtr intPtr, int bytesPerPixel)
        {
            ...
            #if (UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IOS) && !UNITY_EDITOR) || UNITY_5) && !(UNITY_WEBGL && !UNITY_EDITOR)
...
//                      #endif
     ...
     * <p>
     * <br>This function converts Texture to Texture2D.
     * <br>texture and texture2D need to be the same size.
     * <br>texture2D's TextureFormat needs to be RGBA32(Unity5.5+), ARGB32, RGB24, RGBAFloat or RGBAHalf.
     * 
     * @param texture
     * @param texture2D
     */
     ...
     */
        ...
        */
        public static string getFilePath (string filepath, bool refresh = false)
        {
            ...
            string destPath = Application.persistentDataPath + Path.AltDirectorySeparatorChar + "opencvforunity" + Path.AltDirectorySeparatorChar + filepath;
            ...
            string destPath = Path.AltDirectorySeparatorChar + "opencvforunity" + Path.AltDirectorySeparatorChar + filepath;
            ...
            string destPath = System.IO.Path.Combine (Application.streamingAssetsPath, filepath);
            return destPath;
            #else
            filepath = filepath.TrimStart (chTrims);
