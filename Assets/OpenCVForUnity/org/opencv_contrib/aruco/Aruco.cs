...
namespace OpenCVForUnity
{
    public class Aruco
    {
        ...
        public static bool estimatePoseCharucoBoard (Mat charucoCorners, Mat charucoIds, CharucoBoard board, Mat cameraMatrix, Mat distCoeffs, Mat rvec, Mat tvec, bool useExtrinsicGuess)
        {
            ...
            bool retVal = aruco_Aruco_estimatePoseCharucoBoard_10 (charucoCorners.nativeObj, charucoIds.nativeObj, board.nativeObj, cameraMatrix.nativeObj, distCoeffs.nativeObj, rvec.nativeObj, tvec.nativeObj, useExtrinsicGuess);
        ...
        public static bool estimatePoseCharucoBoard (Mat charucoCorners, Mat charucoIds, CharucoBoard board, Mat cameraMatrix, Mat distCoeffs, Mat rvec, Mat tvec)
        {
            ...
            bool retVal = aruco_Aruco_estimatePoseCharucoBoard_11 (charucoCorners.nativeObj, charucoIds.nativeObj, board.nativeObj, cameraMatrix.nativeObj, distCoeffs.nativeObj, rvec.nativeObj, tvec.nativeObj);
        ...
        public static int estimatePoseBoard (List<Mat> corners, Mat ids, Board board, Mat cameraMatrix, Mat distCoeffs, Mat rvec, Mat tvec, bool useExtrinsicGuess)
        {
            ...
            #if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IOS || UNITY_WEBGL) && !UNITY_EDITOR) || UNITY_5
            Mat corners_mat = Converters.vector_Mat_to_Mat (corners);
            int retVal = aruco_Aruco_estimatePoseBoard_10 (corners_mat.nativeObj, ids.nativeObj, board.nativeObj, cameraMatrix.nativeObj, distCoeffs.nativeObj, rvec.nativeObj, tvec.nativeObj, useExtrinsicGuess);
        ...
        public static int estimatePoseBoard (List<Mat> corners, Mat ids, Board board, Mat cameraMatrix, Mat distCoeffs, Mat rvec, Mat tvec)
        {
            ...
            #if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IOS || UNITY_WEBGL) && !UNITY_EDITOR) || UNITY_5
            Mat corners_mat = Converters.vector_Mat_to_Mat (corners);
            int retVal = aruco_Aruco_estimatePoseBoard_11 (corners_mat.nativeObj, ids.nativeObj, board.nativeObj, cameraMatrix.nativeObj, distCoeffs.nativeObj, rvec.nativeObj, tvec.nativeObj);
        ...
        public static int interpolateCornersCharuco (List<Mat> markerCorners, Mat markerIds, Mat image, CharucoBoard board, Mat charucoCorners, Mat charucoIds, Mat cameraMatrix, Mat distCoeffs, int minMarkers)
        {
            ...
            int retVal = aruco_Aruco_interpolateCornersCharuco_10 (markerCorners_mat.nativeObj, markerIds.nativeObj, image.nativeObj, board.nativeObj, charucoCorners.nativeObj, charucoIds.nativeObj, cameraMatrix.nativeObj, distCoeffs.nativeObj, minMarkers);
