    ...
    public class HandPoseEstimationExample : MonoBehaviour
    {
        ...
        void Update ()
        {
            ...
            if (webCamTextureToMatHelper.IsPlaying () && webCamTextureToMatHelper.DidUpdateThisFrame ()) {
                ...
                Imgproc.putText (rgbaMat, "Klik area telapak tangan anda.", new Point (5, rgbaMat.rows () - 10), Core.FONT_HERSHEY_SIMPLEX, 1.0, new Scalar (255, 255, 255, 255), 2, Imgproc.LINE_AA, false);
